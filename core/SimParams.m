classdef SimParams
    properties
        ...
        umin = [-4; -2]; % Minimum values of quantities in the control constraint set
        umax = [4; 2]; % Maximum values of quantities in the control constraint set
        ...
        dt=4; % instantaneous change in time
        N=15; % number of iterations
        d_veh=7; % distance of vehicle from ego
        k_active=0.1; % a constant used to define the clearance from active vehicles
        d_max = 2; %  maximum infringement distance
